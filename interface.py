...
class MainWindow:
    def __init__(self, master):
        ...
        master.wm_title("WHY Translator")
        ...
        # Image
        master.pic = ctk.CTkImage(dark_image=Image.open("WHY.png"), size=(500, 400))
        ...
        master.start.grid(
            row=1, column=1, columnspan=1, padx=(10,5), pady=(5,10), sticky="nsew"
        )
        master.exit.grid(
